// ======================================================================
// HydobServe.v generated from TopDesign.cysch
// 08/27/2017 at 17:51
...
// SW_Tx_UART_v1_50(BaudRate=57600, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SW_TX, CY_INSTANCE_SHORT_NAME=SW_TX, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=SW_TX, )
module SW_Tx_UART_v1_50_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("80dcb30e-fbfa-4256-b987-2c092db9e432/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_button_isr_net;
	wire [0:0] tmpFB_0__Pin_button_isr_net;
	wire [0:0] tmpIO_0__Pin_button_isr_net;
	electrical [0:0] tmpSIOVREF__Pin_button_isr_net;

	cy_psoc3_pins_v1_10
		#(.id("cc025c4a-b920-4a05-888e-9fb81dcf7a9e"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_button_isr
		 (.oe(tmpOE__Pin_button_isr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_button_isr_net[0:0]}),
		  .io({tmpIO_0__Pin_button_isr_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_button_isr_net),
		  .interrupt({Net_4294}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_button_isr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_hall_sig_net;
	wire [0:0] tmpFB_0__Pin_hall_sig_net;
	wire [0:0] tmpIO_0__Pin_hall_sig_net;
	electrical [0:0] tmpSIOVREF__Pin_hall_sig_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_hall_sig
		 (.oe(tmpOE__Pin_hall_sig_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_hall_sig_net[0:0]}),
		  .io({tmpIO_0__Pin_hall_sig_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_hall_sig_net),
		  .interrupt({Net_4144}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_hall_sig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VCC_hall_net;
	wire [0:0] tmpFB_0__VCC_hall_net;
	wire [0:0] tmpIO_0__VCC_hall_net;
	wire [0:0] tmpINTERRUPT_0__VCC_hall_net;
	electrical [0:0] tmpSIOVREF__VCC_hall_net;

	cy_psoc3_pins_v1_10
		#(.id("4b92eb5d-27e2-4db3-b6d1-3e74903e74d9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VCC_hall
		 (.oe(tmpOE__VCC_hall_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VCC_hall_net[0:0]}),
		  .io({tmpIO_0__VCC_hall_net[0:0]}),
		  .siovref(tmpSIOVREF__VCC_hall_net),
		  .interrupt({tmpINTERRUPT_0__VCC_hall_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VCC_hall_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_acc_isr_net;
	wire [0:0] tmpFB_0__Pin_acc_isr_net;
	wire [0:0] tmpIO_0__Pin_acc_isr_net;
	electrical [0:0] tmpSIOVREF__Pin_acc_isr_net;

	cy_psoc3_pins_v1_10
		#(.id("37a3d2cb-37ca-4ba9-b5db-12ecacde70b4"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_acc_isr
		 (.oe(tmpOE__Pin_acc_isr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_acc_isr_net[0:0]}),
		  .io({tmpIO_0__Pin_acc_isr_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_acc_isr_net),
		  .interrupt({Net_4149}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_acc_isr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_CombinedIntr_net;
	wire [0:0] tmpIO_0__Pin_CombinedIntr_net;
	wire [0:0] tmpINTERRUPT_0__Pin_CombinedIntr_net;
	electrical [0:0] tmpSIOVREF__Pin_CombinedIntr_net;

	cy_psoc3_pins_v1_10
		#(.id("30c51061-045b-45fc-8589-f20c1efab4c7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_CombinedIntr
		 (.oe(tmpOE__Pin_CombinedIntr_net),
		  .y({1'b0}),
		  .fb({Net_4298}),
		  .io({tmpIO_0__Pin_CombinedIntr_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_CombinedIntr_net),
		  .interrupt({tmpINTERRUPT_0__Pin_CombinedIntr_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_CombinedIntr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
