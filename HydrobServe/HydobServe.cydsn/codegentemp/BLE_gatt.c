    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x66u] = {
    /* Device Name */
    (uint8)'S', (uint8)'t', (uint8)'r', (uint8)'o', (uint8)'h', (uint8)'h', (uint8)'a', (uint8)'l', (uint8)'m', 
    ...
    /* First_Name */
    (uint8)'B', (uint8)'e', (uint8)'i', (uint8)'s', (uint8)'p', (uint8)'i', (uint8)'e', (uint8)'l', (uint8)'_', (uint8)'V',
(uint8)'o', (uint8)'r', (uint8)'n', (uint8)'a', (uint8)'m', (uint8)'e', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.',
(uint8)'.', (uint8)'.', 

    /* Last_Name */
    (uint8)'B', (uint8)'e', (uint8)'i', (uint8)'s', (uint8)'p', (uint8)'i', (uint8)'e', (uint8)'l', (uint8)'_', (uint8)'N',
(uint8)'a', (uint8)'c', (uint8)'h', (uint8)'n', (uint8)'a', (uint8)'m', (uint8)'e', (uint8)'.', (uint8)'.', (uint8)'.',
(uint8)'.', (uint8)'.', 

    /* User_ID */
    (uint8)'B', (uint8)'e', (uint8)'i', (uint8)'s', (uint8)'p', (uint8)'i', (uint8)'e', (uint8)'l', (uint8)'-', (uint8)'I',
(uint8)'D', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.', (uint8)'.',
(uint8)'.', (uint8)'.', 
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Volume data */
    { 0x2Au, 0xDCu, 0xBCu, 0x7Fu, 0x4Cu, 0x12u, 0xDCu, 0xB7u, 0x13u, 0x46u, 0xAEu, 0xC1u, 0xEAu, 0xAFu, 0xA0u, 0x08u },
    /* drunk_volume */
    { 0x39u, 0x2Au, 0x66u, 0x0Bu, 0x33u, 0x6Bu, 0xD6u, 0xB9u, 0x96u, 0x4Au, 0xF3u, 0x03u, 0x05u, 0xD6u, 0x45u, 0x91u },
    /* number_drink_evts */
    { 0xA2u, 0xD1u, 0xB5u, 0x5Cu, 0x15u, 0xDFu, 0x81u, 0x9Bu, 0x35u, 0x45u, 0x30u, 0x13u, 0xA2u, 0x37u, 0x81u, 0xB4u },
    /* pulse_multiplier */
    { 0xE3u, 0x3Du, 0xE2u, 0x0Bu, 0x1Fu, 0xD5u, 0x14u, 0x9Du, 0xB6u, 0x41u, 0x08u, 0x38u, 0x62u, 0x21u, 0x87u, 0x3Au },
    /* pulse_count */
    { 0xC7u, 0x70u, 0xADu, 0x15u, 0xBFu, 0x68u, 0x41u, 0xB9u, 0x7Fu, 0x49u, 0xB0u, 0x9Eu, 0xD1u, 0x37u, 0xA5u, 0x37u },
    /* user_data */
    { 0xBAu, 0xDCu, 0x3Au, 0xE2u, 0x60u, 0x68u, 0xE7u, 0xB9u, 0xD2u, 0x43u, 0x53u, 0x27u, 0x98u, 0x4Bu, 0xE9u, 0xFAu },
    /* First_Name */
    { 0x9Au, 0xECu, 0x3Fu, 0x80u, 0x38u, 0x41u, 0x29u, 0xB8u, 0x60u, 0x47u, 0xA5u, 0xAAu, 0x6Cu, 0xB8u, 0x45u, 0x38u },
    /* Last_Name */
    { 0x0Au, 0x25u, 0xE7u, 0xA6u, 0xECu, 0x77u, 0xE5u, 0x8Du, 0x86u, 0x43u, 0xA3u, 0xE1u, 0x2Du, 0x45u, 0xCEu, 0x24u },
    /* User_ID */
    { 0x56u, 0x9Cu, 0x6Du, 0x86u, 0xA2u, 0x93u, 0xF8u, 0xB4u, 0x62u, 0x4Bu, 0x81u, 0x93u, 0xE6u, 0xBAu, 0x97u, 0x3Fu },
    /* Gener */
    { 0x89u, 0xBAu, 0xFEu, 0x4Au, 0xAFu, 0x74u, 0xDCu, 0xA2u, 0x72u, 0x46u, 0x2Cu, 0x11u, 0x29u, 0xD8u, 0x6Fu, 0x90u },
    /* Battery */
    { 0xFDu, 0x97u, 0x77u, 0x9Du, 0x66u, 0xF6u, 0x58u, 0xB1u, 0x00u, 0x41u, 0x17u, 0x9Fu, 0x75u, 0x98u, 0x64u, 0x27u },
    /* Battery_level */
    { 0xBBu, 0xF0u, 0x00u, 0xDFu, 0xEBu, 0x1Cu, 0xA3u, 0x8Bu, 0xFCu, 0x40u, 0xC7u, 0xFFu, 0x42u, 0x34u, 0x7Au, 0x62u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Volume data UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* drunk_volume UUID */
    { 0x0002u, (void *)&cyBle_attValues[24] }, /* drunk_volume */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* number_drink_evts UUID */
    { 0x0002u, (void *)&cyBle_attValues[26] }, /* number_drink_evts */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* pulse_multiplier UUID */
    { 0x0004u, (void *)&cyBle_attValues[28] }, /* pulse_multiplier */
    { 0x0010u, (void *)&cyBle_attUuid128[4] }, /* pulse_count UUID */
    { 0x0002u, (void *)&cyBle_attValues[32] }, /* pulse_count */
    { 0x0010u, (void *)&cyBle_attUuid128[5] }, /* user_data UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[6] }, /* First_Name UUID */
    { 0x0016u, (void *)&cyBle_attValues[34] }, /* First_Name */
    { 0x0010u, (void *)&cyBle_attUuid128[7] }, /* Last_Name UUID */
    { 0x0016u, (void *)&cyBle_attValues[56] }, /* Last_Name */
    { 0x0010u, (void *)&cyBle_attUuid128[8] }, /* User_ID UUID */
    { 0x0016u, (void *)&cyBle_attValues[78] }, /* User_ID */
    { 0x0010u, (void *)&cyBle_attUuid128[9] }, /* Gener UUID */
    { 0x0001u, (void *)&cyBle_attValues[100] }, /* Gener */
    { 0x0010u, (void *)&cyBle_attUuid128[10] }, /* Battery UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[11] }, /* Battery_level UUID */
    { 0x0001u, (void *)&cyBle_attValues[101] }, /* Battery_level */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x22u] = {
    ...
    { 0x000Eu, 0x2800u /* Primary service                     */, 0x00080001u /*       */, 0x0016u, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0010u, 0xd605u /* drunk_volume                        */, 0x00090A04u /* rd,wr */, 0x0010u, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0012u, 0x37a2u /* number_drink_evts                   */, 0x00090A04u /* rd,wr */, 0x0012u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x0014u, {{0x0010u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0014u, 0x2162u /* pulse_multiplier                    */, 0x00090A04u /* rd,wr */, 0x0014u, {{0x0004u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x0016u, {{0x0010u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0016u, 0x37d1u /* pulse_count                         */, 0x00090A04u /* rd,wr */, 0x0016u, {{0x0002u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0017u, 0x2800u /* Primary service                     */, 0x00080001u /*       */, 0x001Fu, {{0x0010u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0018u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x0019u, {{0x0010u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0019u, 0xb86cu /* First_Name                          */, 0x00090A04u /* rd,wr */, 0x0019u, {{0x0016u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x001Bu, {{0x0010u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Bu, 0x452du /* Last_Name                           */, 0x00090A04u /* rd,wr */, 0x001Bu, {{0x0016u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Cu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x001Du, {{0x0010u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x001Du, 0xbae6u /* User_ID                             */, 0x00090A04u /* rd,wr */, 0x001Du, {{0x0016u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x001Eu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x001Fu, {{0x0010u, (void *)&cyBle_attValuesLen[22]}} },
    { 0x001Fu, 0xd829u /* Gener                               */, 0x00090A04u /* rd,wr */, 0x001Fu, {{0x0001u, (void *)&cyBle_attValuesLen[23]}} },
    { 0x0020u, 0x2800u /* Primary service                     */, 0x00080001u /*       */, 0x0022u, {{0x0010u, (void *)&cyBle_attValuesLen[24]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd    */, 0x0022u, {{0x0010u, (void *)&cyBle_attValuesLen[25]}} },
    { 0x0022u, 0x3442u /* Battery_level                       */, 0x00090201u /* rd    */, 0x0022u, {{0x0001u, (void *)&cyBle_attValuesLen[26]}} },
};
