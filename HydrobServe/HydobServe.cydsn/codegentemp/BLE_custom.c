...
const CYBLE_CUSTOMS_T cyBle_customs[0x03u] = {
    ...
    /* Volume data service */
    {
        0x000Eu, /* Handle of the Volume data service */ 
        {

            /* drunk_volume characteristic */
            {
                0x0010u, /* Handle of the drunk_volume characteristic */ 
            ...
            /* number_drink_evts characteristic */
            {
                0x0012u, /* Handle of the number_drink_evts characteristic */ 
            ...
            /* pulse_multiplier characteristic */
            {
                0x0014u, /* Handle of the pulse_multiplier characteristic */ 
            ...
            /* pulse_count characteristic */
            {
                0x0016u, /* Handle of the pulse_count characteristic */ 
    ...
    /* user_data service */
    {
        0x0017u, /* Handle of the user_data service */ 
        {

            /* First_Name characteristic */
            {
                0x0019u, /* Handle of the First_Name characteristic */ 
            ...
            /* Last_Name characteristic */
            {
                0x001Bu, /* Handle of the Last_Name characteristic */ 
            ...
            /* User_ID characteristic */
            {
                0x001Du, /* Handle of the User_ID characteristic */ 
            ...
            /* Gener characteristic */
            {
                0x001Fu, /* Handle of the Gener characteristic */ 
    ...
    /* Battery service */
    {
        0x0020u, /* Handle of the Battery service */ 
        {

            /* Battery_level characteristic */
            {
                0x0022u, /* Handle of the Battery_level characteristic */ 
