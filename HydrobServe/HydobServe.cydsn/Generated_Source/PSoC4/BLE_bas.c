...
const CYBLE_BASS_T cyBle_bass[0x01u] = {
    {
        0x0020u, /* Handle of the BAS service */ 
        0x0022u, /* Handle of the Battery Level characteristic */ 
        0x0023u, /* Handle of the Characteristic Presentation Format descriptor */ 
