...
.global SW_TX_pinNumber
.global SW_TX_pinPortNumber
...
.global SW_TX_PutChar
.func SW_TX_PutChar, SW_TX_PutChar
.type SW_TX_PutChar, %function
.thumb_func
SW_TX_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word SW_TX_pinNumber
PORT_NUMBER:
    .word SW_TX_pinPortNumber
PORT_DR_ADDRESS:
    .word SW_TX_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 57600
