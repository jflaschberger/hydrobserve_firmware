...
;==============================================================================
    ...
    IMPORT SW_TX_pinNumber
    IMPORT SW_TX_pinPortNumber
    IMPORT SW_TX_pinDrAdress
    ...
    PUBLIC SW_TX_PutChar
    THUMB


;------------------------------------------------------------------------------
; Function Name: SW_TX_PutChar
;------------------------------------------------------------------------------
;
; Summary:
...
bitTxLoop:
    ...
    DATA
PIN_NUMBER dc32 SW_TX_pinNumber
PORT_NUMBER dc32 SW_TX_pinPortNumber
PORT_DR_ADDRESS dc32 SW_TX_pinDrAdress
FREQ dc32 cydelayFreqHz
BAUD_RATE dc32 57600
